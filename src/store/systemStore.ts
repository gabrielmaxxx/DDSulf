...
export const DEFAULT_INVENTORY_PRODUCTS: InventoryProduct[] = [
  {
    id: 'prod-kothrine-250',
    name: 'K-Othrine WG 250 (Potes 500g)',
    category: 'inseticida',
    unit: 'g',
    quantity: 18,
    minQuantity: 10,
    ...
    activeIngredient: 'Deltametrina 25%',
    productGroup: 'Inseticidas Residual',
    lot: 'BAY-2026-X1',
    expiryDate: '2026-12-15',
    lastUpdated: new Date().toISOString(),
  },
  {
    id: 'prod-bifentol-200sc',
    name: 'Bifentol 200 SC (Frasco 1L)',
    category: 'inseticida',
    unit: 'L',
    quantity: 4,
    minQuantity: 5,
    idealQuantity: 15,
    costPerUnit: 145,
    supplier: 'Rogama / Syngenta',
    chemicalGroup: 'Piretroide',
    activeIngredient: 'Bifentrina 20%',
    productGroup: 'Inseticidas Líquidos Concentrados',
    lot: 'ROG-8821',
    expiryDate: '2026-11-20',
    lastUpdated: new Date().toISOString(),
  },
  {
    id: 'prod-racumin-pasta',
    name: 'Racumin Pasta Raticida (Sachês 100g)',
    category: 'raticida',
    unit: 'kg',
    quantity: 12,
    minQuantity: 6,
    ...
    activeIngredient: 'Coumatetralil 0,0375%',
    productGroup: 'Rodenticidas Anticoagulantes',
    lot: 'BAY-RAC-409',
    expiryDate: '2027-04-10',
    lastUpdated: new Date().toISOString(),
  },
  {
    id: 'prod-maxforce-gel',
    name: 'Gel Baraticida Maxforce Prime (Bisnagas 30g)',
    category: 'gel_baraticida',
    unit: 'unidade',
    quantity: 24,
    minQuantity: 10,
    idealQuantity: 35,
    ...
    activeIngredient: 'Imidacloprido 2,15%',
    productGroup: 'Iscas Gel Baraticidas',
    lot: 'ENV-GEL-91',
  ...
  {
    id: 'prod-mirex-s',
    name: 'Formicida Mirex-S Isca Granulada (Pct 500g)',
    category: 'formicida',
    unit: 'kg',
    quantity: 8,
    minQuantity: 4,
    ...
    costPerUnit: 28,
    supplier: 'Atta Kill',
    chemicalGroup: 'Sulfonamida Fluoroalifática',
    activeIngredient: 'Sulfluramida 0,3%',
    productGroup: 'Iscas Granuladas para Formigas',
    lot: 'ATT-2026-03',
    expiryDate: '2026-10-30',
    lastUpdated: new Date().toISOString(),
  },
  {
    id: 'prod-guarany-pulverizador',
    name: 'Pulverizador Costal de Alavanca Guarany 20L',
    ...
    idealQuantity: 5,
    costPerUnit: 390,
    supplier: 'Guarany Indústria',
    chemicalGroup: 'Equipamento de Aplicação',
    activeIngredient: 'N/A',
    productGroup: 'Maquinário e Pulverizadores',
    lot: 'EQ-GUAR-20',
    lastUpdated: new Date().toISOString(),
  },
  {
    id: 'prod-respirador-3m',
    name: 'Respirador Semi-Facial 3M Série 6200 c/ Filtros',
    category: 'epi',
    unit: 'unidade',
    quantity: 8,
    minQuantity: 4,
    ...
    chemicalGroup: 'Proteção Respiratória Individual',
    activeIngredient: 'N/A',
    productGroup: 'EPIs e Proteção Operacional',
    lot: 'EPI-3M-VO',
    lastUpdated: new Date().toISOString(),
  }
];
