...
export const AI_COMM_PROMPTS = {
  notificationAnalyzer: `Como um analista de operações do PestFlow (plataforma de controle de pragas), analise esta notificação operacional e retorne um objeto JSON contendo:
